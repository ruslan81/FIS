...
AnyChartStock.VERSION = "1.0.0 Revision #7488";
...
AnyChartStock.prototype = {
	...
	getSeriesValue: function(chartId, seriesId) {
		return (this.flashObject && this.flashObject.getSeriesValue) ? this.flashObject.getSeriesValue(chartId, seriesId) : null;
	},

	getSeriesValueChange: function(chartId, seriesId) {
		return (this.flashObject && this.flashObject.getSeriesValueChange) ? this.flashObject.getSeriesValueChange(chartId, seriesId) : null;
	},

	getSeriesPercentValueChange: function(chartId, seriesId) {
		return (this.flashObject && this.flashObject.getSeriesPercentValueChange) ? this.flashObject.getSeriesPercentValueChange(chartId, seriesId) : null;
	},

	getSeriesOpenValue: function(chartId, seriesId) {
		return (this.flashObject && this.flashObject.getSeriesOpenValue) ? this.flashObject.getSeriesOpenValue(chartId, seriesId) : null;
	},

	getSeriesCloseValue: function(chartId, seriesId) {
		return (this.flashObject && this.flashObject.getSeriesCloseValue) ? this.flashObject.getSeriesCloseValue(chartId, seriesId) : null;
	},

	getSeriesHighValue: function(chartId, seriesId) {
		return (this.flashObject && this.flashObject.getSeriesHighValue) ? this.flashObject.getSeriesHighValue(chartId, seriesId) : null;
	},

	getSeriesLowValue: function(chartId, seriesId) {
		return (this.flashObject && this.flashObject.getSeriesLowValue) ? this.flashObject.getSeriesLowValue(chartId, seriesId) : null;
	},

	getSeriesCustomValue: function(chartId, seriesId, valueField) {
		return (this.flashObject && this.flashObject.getSeriesCustomValue) ? this.flashObject.getSeriesCustomValue(chartId, seriesId, valueField) : null;
	},
	...
	getTechnicalIndicatorValue: function(chartId, techIndicatorId) {
		return (this.flashObject && this.flashObject.getTechnicalIndicatorValue) ? this.flashObject.getTechnicalIndicatorValue(chartId, techIndicatorId) : null;
	},

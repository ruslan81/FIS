<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GeneralTab_CretingFormsControl.ascx.cs" Inherits="AdministratorS_CreatingFormsControls_GeneralTab_CretingFormsControl" %>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DealersTab_UserControl.ascx.cs"
    Inherits="Administrator_Adminisration_UserControls_DealersTab_UserControl" %>

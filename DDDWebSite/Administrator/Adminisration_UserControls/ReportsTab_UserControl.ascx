<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReportsTab_UserControl.ascx.cs" Inherits="Administrator_Adminisration_UserControls_ReportsTab_UserControl" %>

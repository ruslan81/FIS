<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ClientsTab_UserControl.ascx.cs" Inherits="Administrator_Adminisration_UserControls_ClientsTab_UserControl" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register src="../../UserControlsForAll/BlueButton.ascx" tagname="BlueButton" tagprefix="uc2" %>

<asp:Panel ID="ClientsDataPanel" runat="server" Width="100%" ScrollBars="Auto" Height="100%">
                ...
                <asp:Table ID="UserButtonsTable" runat="server" Width="100%" GridLines="None">
                    <asp:TableRow>
                        <asp:TableCell Width="150px" HorizontalAlign="Left">
                            <uc2:BlueButton ID="NewClientButton" Text="Новый клиент" CausesValidation="false" runat="server"/>
                        </asp:TableCell>
                        <asp:TableCell Width="100px">
                            <uc2:BlueButton ID="EditClientButton" Text="Редактировать" CausesValidation="false" runat="server"/>
                        </asp:TableCell>
                        <asp:TableCell Width="100px">
                            <uc2:BlueButton ID="SaveClientButton" Text="Сохранить" Enabled="false" runat="server"/>
                        </asp:TableCell>
                        <asp:TableCell Width="100px">
                            <uc2:BlueButton ID="CancelClientButton" Text="Отмена" Visible="false" CausesValidation="false" runat="server"/>
                        </asp:TableCell>
                        <asp:TableCell />
                        <asp:TableCell Width="100px">
                            <uc2:BlueButton ID="DeleteClientButton" Text="Удалить" runat="server" CausesValidation="false" 
                                OnClientClick="if(confirm('Вы уверены, что хотите удалить этого клиента?')) { return true; } else { return false; }"/>
            ...
            <ContentTemplate>
                <div id="tabs">                
                    <ul style="height:30px;">
		                <li><asp:LinkButton ID="ClientsTab" runat="server" Text="Клиенты" href="#tabs-1"/></li>
		                <li><asp:LinkButton ID="DetailedInfoTab" runat="server" Text="Детальная информация" href="#tabs-2"/></li>
	                </ul>
                    <div id="tabs-1">
                            <asp:UpdatePanel ID="ClientsDataGridUpdatePanel" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div class="ui-jqgrid">
                                        <asp:DataGrid ID="ClientsDataGrid" runat="server" Width="100%" AutoGenerateColumns="false" 
                                            ...
                                            <Columns>
                                                <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:RadioButton ID="ClientsDataGrid_RadioButton" runat="server" AutoPostBack="true"
                                                            OnCheckedChanged="ClientsDataGrid_RadioButton_Checked" CausesValidation="false"/>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:BoundColumn DataField="CLIENTNAME" HeaderText="Клиент" ReadOnly="true" />
                                    ...
                                    <asp:HiddenField ID="Selected_ClientsDataGrid_Index" runat="server" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                    </div>
                    <div id="tabs-2">
                                ...
                                <ContentTemplate>
                                    <asp:Panel ID="DetailedInformationPanel" runat="server" Enabled="false">
                                        <asp:Panel ID="Panel1" runat="server" BorderWidth="1px" BorderColor="LightGray">
                                            <asp:Table runat="server" ID="DetailedInfoMainTable" Width="100%" CellPadding="5">
                                                <asp:TableRow>
                                                    <asp:TableCell Width="60%">
                                                        <asp:Label runat="server" ID="DetailedInfo_ClientName_Label" Text="Наименование клиента" />
                                                        <asp:TextBox runat="server" ID="DetailedInfo_ClientName_TextBox" BackColor="LightGreen" Width="100%" />
                                                        <asp:RequiredFieldValidator ID="DetailedInfo_ClientName_TextBox_ReqFVal" runat="server" 
                                                            ErrorMessage="<b>Поле пустое!</b><p>Введите название клиента.</p>" ControlToValidate="DetailedInfo_ClientName_TextBox" Display="None"/>
                                                        <asp:ValidatorCalloutExtender ID="DetailedInfo_ClientName_TextBox_ReqFValE" runat="server" TargetControlID="DetailedInfo_ClientName_TextBox_ReqFVal"
                                            ...
                                            <asp:Table runat="server" ID="DetailedInfoLogPassTable" Width="100%" CellPadding="5" Visible="false">
                                                <asp:TableRow>
                                                    <asp:TableCell Width="20%">

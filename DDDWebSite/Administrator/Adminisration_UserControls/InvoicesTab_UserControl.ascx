<%@ Control Language="C#" AutoEventWireup="true" CodeFile="InvoicesTab_UserControl.ascx.cs"
    Inherits="Administrator_Adminisration_UserControls_InvoicesTab_UserControl" %>

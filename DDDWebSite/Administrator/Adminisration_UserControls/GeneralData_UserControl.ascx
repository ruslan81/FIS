<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GeneralData_UserControl.ascx.cs" Inherits="Administrator_Adminisration_UserControls_GeneralData_UserControl" %>

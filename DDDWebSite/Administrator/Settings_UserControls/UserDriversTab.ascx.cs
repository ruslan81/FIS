...
public partial class Administrator_Settings_UserControls_UserDriversTab : System.Web.UI.UserControl
{
    ...
    public void SaveAllNewInformation()
    {
        ...
        try
        {
            ...
            int newCardId = dataBlock.cardsTable.CreateNewCard(name + " " + surName, driversCard, dataBlock.cardsTable.driversCardTypeId, orgId,0, "Created manually " + name + " " + surName + " " + driversCard, curUserId,1);
